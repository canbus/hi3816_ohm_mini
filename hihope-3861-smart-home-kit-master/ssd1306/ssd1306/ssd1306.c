...
void ssd1306_Init_(void)
{
    // ssd1306_WriteCommand(0x00 );
    // ssd1306_WriteCommand(0x8d );  
    // ssd1306_WriteCommand(0x14 );
    // ssd1306_WriteCommand(0xAF);
    uint8_t data[]={0x00,0x8D,0x14,0x81,0xFF,0xAF};
    uint8_t ret = IoTI2cWrite(SSD1306_I2C_IDX, SSD1306_I2C_ADDR, data, sizeof(data));
    printf("i2c write ret:%x\n",ret);
}
